...
peso = float(input('Insira o peso total dos peixes que foram pescados: '))
excesso = peso - 50
multa = excesso * 4.00
print(f'João pescou um total de {peso} kg de peixe, excedendo {excesso} kg pelo regulamento, '
      f'João deverá pagar R$ {multa} de multa. ')